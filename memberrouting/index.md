...
3) If this routing is turned off, the Respondent is returned to the Partner and the Partner is notified through the Terminates Notiication method desribed [here.](http://docs.integratedpanel.toluna.com/notifications/memberstatus.html#terminates)
...
6) If the Respondent qualifies and completes the new Survey, the Partner is notified using the Completion notification method described [here.](http://docs.integratedpanel.toluna.com/notifications/memberstatus.html#completions)

7) If the Respondent terminates from the new Survey, the Partner is notified through the Terminates Notiication method desribed [here.](http://docs.integratedpanel.toluna.com/notifications/memberstatus.html#terminates)
